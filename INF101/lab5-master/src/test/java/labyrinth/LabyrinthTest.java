...
public class LabyrinthTest {
	...
	public void goodMoveTestN() {
		...
		assertEquals(LabyrinthTile.PLAYER, labyrinth.getCell(new CellPosition(2, 1)));
	}

	@Test
	public void goodMoveTestNNE() {
		assertEquals(LabyrinthTile.PLAYER, labyrinth.getCell(new CellPosition(3, 1)));
		assertDoesNotThrow(() -> labyrinth.movePlayer(GridDirection.NORTH));
		assertEquals(LabyrinthTile.PLAYER, labyrinth.getCell(new CellPosition(2, 1)));
		assertDoesNotThrow(() -> labyrinth.movePlayer(GridDirection.NORTH));
		assertEquals(LabyrinthTile.PLAYER, labyrinth.getCell(new CellPosition(1, 1)));
		assertDoesNotThrow(() -> labyrinth.movePlayer(GridDirection.EAST));
		assertEquals(LabyrinthTile.PLAYER, labyrinth.getCell(new CellPosition(1, 2)));
	}
	...
	@Test
	void gridGet() {
		assertEquals(LabyrinthTile.WALL, labyrinth.getCell(new CellPosition(0, 0)));
		assertEquals(LabyrinthTile.WALL, labyrinth.getCell(new CellPosition(4, 2)));
		assertEquals(LabyrinthTile.WALL, labyrinth.getCell(new CellPosition(1, 3)));
		assertEquals(LabyrinthTile.PLAYER, labyrinth.getCell(new CellPosition(3, 1)));
		assertEquals(LabyrinthTile.OPEN, labyrinth.getCell(new CellPosition(2, 1)));
	}
